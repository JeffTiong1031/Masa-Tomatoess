...
export default function ThemeModal() {
  ...
  return (
    <>
      ...
      >
        <p className="text-sm text-[var(--mt-text-muted)] mb-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <button
            ...
            className={`relative aspect-video rounded-xl overflow-hidden transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--mt-focus)] ${
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 bg-black/55 px-2 py-1.5">
              <span className="text-xs font-medium text-white">Midnight Gradient</span>
            </div>
          </button>
            ...
            >
              {theme.kind === 'image' ? (
                ...
                >
                  ...
                  <span className="absolute top-2 left-2 text-[10px] uppercase tracking-wider bg-black/50 px-1.5 py-0.5 rounded text-white">
                    Live
                  </span>
                </div>
              )}
          ...
          >
            <Upload size={22} className="text-[var(--mt-text-muted)] mb-2" />
            <span className="text-xs font-medium text-[var(--mt-text)] px-2 text-center">
        ...
        {error && (
          <p className="mt-4 text-sm text-[var(--mt-danger)]" role="alert">
            {error}
          </p>
        )}
      </Modal>
